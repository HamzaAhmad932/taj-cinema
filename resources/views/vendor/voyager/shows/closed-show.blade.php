...
@stop
@section('page_title', 'Viewing Closed Shows')

@section('page_header')
    <h1 class="page-title">
        <i class="icon voyager-new"></i> Closed Shows
    </h1>
@stop
                ...
                <div class="modal-header">
                    <div class="row">
                        <div class="col-sm-3 text-left">
                            <h4 class="modal-title"><i class="voyager-edit"></i> Sharesssssss</h4>
                        </div>
...
@section('javascript')
    ...
    <script>
        ...
        * *******************************************************************
        */
        var calculateStaffTickets = function() {
            ...
            let tickts_amount = $('#per_ticket_amount').val() * tickets;
            let l_collection = $('#total_amount').val() - tickts_amount;
