...
@section('javascript')
    <script>
        ...
        $('document').ready(function () {
            ...
            /** Hide Gallary and Box fields at start*/
            $('input[name=gallery]').parent().hide();
            $('input[name=box]').parent().hide();
            $('input[name=glasses_price]').parent().hide();

            $('select[name=screen_id]').on('change', function(e){
                let screen = $(this).val();

                if(screen == '1'){
                    $('input[name=hall]').show();
                    $('input[name=gallery]').parent().show();
                    $('input[name=box]').parent().show();
                }else{
                    $('input[name=hall]').parent().show();
                    $('input[name=gallery]').parent().hide();
                    $('input[name=box]').parent().hide();
                }
            });
            ...
            $("input[name=format]").on('change', function(){
                ...
                if(val == '3D'){
                    $('input[name=glasses_price]').parent().show();
                }
            });
